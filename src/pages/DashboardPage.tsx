...
const DashboardPage: React.FC = () => {
  ...
  const openProfileSetupModal = () => setIsProfileSetupModalOpen(true);
  const closeProfileSetupModal = () => setIsProfileSetupModalOpen(false);
  const handleProfileSetupComplete = (member: Partial<Member>) => {
    console.log('Profile setup complete:', member);
        ...
        <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-xl p-6 mb-8 text-white shadow-lg">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button 
              ...
              className="bg-secondary-700 bg-opacity-30 hover:bg-opacity-40 text-white px-5 py-2.5 rounded-lg font-medium transition-colors duration-200 flex items-center border border-secondary-400 border-opacity-30"
            >
