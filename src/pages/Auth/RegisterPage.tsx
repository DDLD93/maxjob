  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-4">
        ...
        <p className="text-secondary-600 mt-2 text-lg">Join MaxJob Africa today</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <label htmlFor="confirmPassword" className={`block text-sm font-semibold transition-colors duration-200 ${focusedField === 'confirmPassword' ? 'text-primary-600' : 'text-secondary-700'}`}>
            Confirm Password
          </label>
          <div className={`relative group transition-all duration-300 ${focusedField === 'confirmPassword' ? 'scale-[1.01]' : ''}`}>
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Lock className={`h-5 w-5 transition-colors duration-200 ${focusedField === 'confirmPassword' ? 'text-primary-500' : 'text-secondary-400'}`} />
            </div>
            <input
              id="confirmPassword"
              type={showPassword ? 'text' : 'password'}
      ...
      <div className="mt-6 text-center">
        <p className="text-xs text-secondary-500">
          By creating an account, you agree to our <Link to="/terms" className="underline hover:text-primary-600">Terms of Service</Link> and <Link to="/privacy" className="underline hover:text-primary-600">Privacy Policy</Link>
        </p>
      </div>
    </div>
  );
